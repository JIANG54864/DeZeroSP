...
from dezerosp.utils import get_file, cache_dir
from dezerosp.transforms import Compose, Flatten, ToFloat, Normalize
...
#     train_set = CIFAR10(train=True, transform=None)
#     print(len(train_set))
